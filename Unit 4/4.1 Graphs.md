...
**Weighted** graphs show the **weight** of each edge. Weights typically represent the cost or time to get from one vertex to another vertex. If a weight is not specified, the weight is 1 by default.
