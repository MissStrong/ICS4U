...
**Djikstra's algorithm** is a greedy algorithm that finds the shortest paths from a specific vertex to all other vertices. At each step, you visit one new node and calculate the shortest path you've seen so far. Here is an example.
