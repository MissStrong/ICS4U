# [Link to Video](https://www.youtube.com/watch?v=CFKu3VZM4TY&list=PLVD25niNi0BlJk16vP7-qI-uiuEv0aaTK)
...
Tabulation involves storing answers starting from the base case and building upwards. This allows us to make multiple function calls efficiently.

```java
private static HashMap<Integer, Integer> table = new HashMap(Map.of(1, 1, 2, 1));
