# [Link to video.](https://www.youtube.com/watch?v=-iUM7cYUykg&list=PLVD25niNi0BnyWtuQTSchyZWbQrMq_PUu)
...
When using a programming language for the first time, it is traditional to run a program that prints "Hello World!" to the console.
