...
Matcher bciPhoneNumber = phoneNumberPattern.matcher(bciPhone); // compiles the string with the pattern
...
Matcher bciPhoneMatcher = tenDigits.matcher(bciPhone); // compiles the string with the pattern
