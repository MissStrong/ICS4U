# [Link to video.](https://www.youtube.com/watch?v=y7d81ja4UB8&list=PLVD25niNi0BmTEl0Ek3UtHR41o5kURAh8)
...
Fortunately, each primitive data type has a corresponding **wrapper class** that we can use instead. 
